                ...
                <form id="demo-form" action="<?php echo e(route('store-contact')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        <button type="submit" class="g-recaptcha border-2 border-blue-500 hover:border-blue-700 px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium text-lg rounded-lg hover:bg-gradient-to-l transition duration-300 ease-in-out transform hover:scale-105 w-fit mx-auto"
                            data-sitekey="<?php echo e(env('GOOGLE_CAPTCHA_SITE_KEY')); ?>" 
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal Projects\vinod-profile\resources\views/welcome.blade.php ENDPATH**/ ?>