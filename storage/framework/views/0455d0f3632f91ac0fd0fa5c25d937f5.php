...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> | Vinod Bodke</title>
    ...
    <?php echo $__env->yieldContent('structure_tag'); ?>
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="" class="flex items-center text-blue-950 hover:text-blue-600 transition duration-300 ease-in-out">
                        <img src="<?php echo e(asset('images/profile.JPG')); ?>" alt="Vinod Bodke" class="w-16 h-16 object-cover rounded-full" oncontextmenu="return false;">
                        ...
                        <div x-data="{ open: false }">
                            ...
                            <div x-show="open" class="fixed inset-y-0 left-0 w-[70%] bg-gray-50 border-l-2 border-gray-200 pt-16 px-4 z-50">
                                ...
                                <ul class="my-4 flex flex-col gap-4">
                                    <li class="<?php echo e(request()->is('#home') ? 'underline decoration-primary underline-offset-8' : ''); ?>">
                                        <a href="#home">Home</a>
                                    </li>
                                    <li class="<?php echo e(request()->is('#about') ? 'underline decoration-primary underline-offset-8' : ''); ?>">
                                        <a href="#about">About</a>
                                    </li>
                                    <li class="<?php echo e(request()->is('#skills') ? 'underline decoration-primary underline-offset-8' : ''); ?>">
                                        <a href="#skills">Skills</a>
                                    </li>
                                    <li class="<?php echo e(request()->is('#contact') ? 'underline decoration-primary underline-offset-8' : ''); ?>">
...
<?php $component->withName('ri-linkedin-box-fill'); ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ri-github-fill'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ri-instagram-line'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ri-youtube-line'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->yieldPushContent('logic_scripts'); ?> 
...
</html><?php /**PATH D:\Personal Projects\vinod-profile\resources\views/layout/base.blade.php ENDPATH**/ ?>